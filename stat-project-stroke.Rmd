...
table(training.set$stroke, qda.fit.train.pred.class, dnn=c('ground thruth','QDA 
            predicted'))
```
From the above result we can see a clear difference and effectiveness of the designed thresholds. We can see by looking at the confusion matrices of the first two example of models where we applied both metrics.
