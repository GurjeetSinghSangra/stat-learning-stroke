...
We construct the training set made of 75% instances of those that are not affected by the stroke, and the 57% of the stroke cases.
```{r}
...
It has also to concern that more data should be collected especially for persons affected by stroke and also more correlated pathological variable and health indicators should be considered too, by looking at the available medical literature. These analysis and integration will allow to build more reliable explanatory and predictive models.
