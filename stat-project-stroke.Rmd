...
\textcolor{red}{Furthermore from this model we have been able to find some little interactions among `heart_disease` and `age` which should be analyzed more.}
...
A good solution can be to find by exploiting features related with the stroke disease, in order to produce relevant results.
