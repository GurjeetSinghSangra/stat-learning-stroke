...
From Figure \ref{bp} we can see that in the first two boxplots (starting from the left) there are lots of outliers, whose range can also be seen from the summary of the `avg_glucose_level` and `bmi` variables and applying the following formula: $max\_value \, -\, q_{3/4}*1.5 \,IQR$, where $q_{1/4}, q_{3/4}$ are the first and third quantile, and $IQR = q_{3/4} - q_{1/4}$ is the interquantile range. So we have a range of outliers of
$$ 271 - (113.57+1.5*(113.57-77.07)) = 102.68$$
for the glucose, and a range of
$$ 97.60 - (33.10 + 1.5 *(33.10-23.50))= 50.10 $$
