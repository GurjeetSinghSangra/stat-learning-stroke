...
\texttt{avg\_glucose\_level} and \texttt{bmi}. We compute the blabla
using the following formula: \(q_{3/4}*1.5 \,IQR\), where
\(q_{1/4}, q_{3/4}\) are the first and third quantile, and
\(IQR = q_{3/4} - q_{1/4}\) is the interquantile range. So we have a
blabla of \[113.57+1.5*(113.57-77.07) = 168.32\] for the glucose, and a
blabla of \[33.10 + 1.5 *(33.10-23.50)= 47.50 \] for the body mass
index.\\
...
\begin{verbatim}
## I seguenti oggetti sono mascherati da stroke_data (pos = 6):
## 
##     age, avg_glucose_level, bmi, ever_married, gender, heart_disease,
##     hypertension, Residence_type, smoking_status, stroke, work_type
\end{verbatim}
...
## 1 0.05571409   0.7887564     0.78125 0.0087606149 0.99375 0.07165390
## 2 0.05546899   0.7827939     0.78125 0.0081128076 0.99375 0.07175090
## 3 0.03401788   0.7646224     0.79375 0.0101456737 0.98750 0.07748897
## 4 0.02374645   0.7234526     0.84375 0.0002552644 0.99375 0.06901042
\end{verbatim}
...
\begin{verbatim}
## [1] "Positive error rate is : 0.063241"
\end{verbatim}

\begin{verbatim}
## [1] "Negative error rate is : 0.002137"
\end{verbatim}
...
\begin{verbatim}
## [1] "Positive error rate is : 0.066860"
\end{verbatim}

\begin{verbatim}
## [1] "Negative error rate is : 0.005566"
\end{verbatim}
...
\begin{verbatim}
## [1] "Positive error rate is : 0.062176"
\end{verbatim}

\begin{verbatim}
## [1] "Negative error rate is : 0.002198"
\end{verbatim}
...
3.1.\\
We also noticed that the QDA model shows better results than LDA, since
it exploits the heteroscedasticity among stroke classes.
